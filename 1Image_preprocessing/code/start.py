...
def main():
    ...
    for i in range(1, 66):
        ...
        erosion_img.append(cv2.imread(f'1Image_preprocessing/imgs/operate_imgs/3mor_erosion/{i}_erosion.png'))
        try:
        ...
        close_img.append(cv2.imread(f'1Image_preprocessing/imgs/operate_imgs/4close/{i}_close.png'))
        try:
